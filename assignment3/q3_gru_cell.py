...
class GRUCell(tf.nn.rnn_cell.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
	    ...
	    b_z = tf.get_variable('b_z', (self.state_size, ), tf.float32)
	    ...
	    b_r = tf.get_variable('b_r', (self.state_size, ), tf.float32)
	    ...
	    b_o = tf.get_variable('b_o', (self.state_size, ), tf.float32)
